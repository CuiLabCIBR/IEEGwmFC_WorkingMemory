...
%% Initialize GUI Panel
    ...
    iEEGPrepApp.UiFig = uifigure; 
    iEEGPrepApp.UiFig.Name = 'iEEGPrep v0.1.6';
    ...
    iEEGPrepApp.UiFig.Position = [xPos yPos figWidth figHeight];
    % Create a grid layout and define its properties.  
    GridLayout = uigridlayout(iEEGPrepApp.UiFig);
    ...
    f_createPanel(GridLayout, [1 length(GridLayout.RowHeight)-1], 1, 'iEEGPrep Pipeline');
...
%% Button 1 - Initiates minimal preprocessing of iEEG data  
    ...
    function set_MiniPrep_panel(~, ~) 
        ...
        if Button{1}.Value
            ...
            mb1_iEEGPrepPipeline_panel(iEEGPrepApp, GridLayout);  
        else  
...
%% Button 2 - Initiates iEEG data visualization
    ...
    function set_iEEGVisualization_panel(~, ~)
        ...
        if Button{2}.Value
            ...
            iEEGPrepApp.State = 'QualityControl';
            ...
            mb2_QualityControl_panel(iEEGPrepApp, GridLayout);
        else
...
%% Button 3 -  Initiates iEEG data Ref-reference.
    ...
    function set_iEEGReference_pannel(~, ~)  
        ...
        if Button{3}.Value  
            ...
            iEEGPrepApp.State = 'iEEGRereference';  
            ...
            mb3_iEEGReference_panel(iEEGPrepApp, GridLayout);  
        else   
...
%% Button 4 - Initiates IED auto-detection.
    ...
    function set_IEDDetection_pannel(~, ~)
        ...
        if Button{4}.Value
            ...
            iEEGPrepApp.State = 'IEDDetection';
            ...
            mb4_IEDDetection_panel(iEEGPrepApp, GridLayout);
        else
...
%% Button 5 - Initiates HFO auto detection.
    ...
    function set_HFODetection_pannel(~, ~)
        ...
        if Button{5}.Value
            ...
            iEEGPrepApp.State = 'HFODetection';
            ...
            mb5_HFODetection_panel(iEEGPrepApp, GridLayout);
        else 
...
%% Button 6 - Initiates HFO Visualization.
    ...
    function set_HFOVisualization_pannel(~, ~)
        ...
        if Button{6}.Value
            ...
            iEEGPrepApp.State = 'HFOVisualization';
            ...
            mb6_HFOVisualization_panel(iEEGPrepApp, GridLayout);
        else 
