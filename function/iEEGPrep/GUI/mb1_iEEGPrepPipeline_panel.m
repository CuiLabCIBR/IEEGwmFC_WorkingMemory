function mb1_iEEGPrepPipeline_panel(iEEGPrepApp, GridLayout)
...
%% Run Button  
    ...
    RunButton= ui_createRunButton(iEEGPrepApp, GridLayout, [2 3], [3 7]);
...
%% Set the Directory of BIDS
    ...
    function setBIDSDir(src, ~)  
        ...
        [Setting.SubjectList, Setting.InputFiles] = ui_inputFiles_InfoPanel(iEEGPrepApp.State, Setting, GridLayout);   % Update subject list and input files.  
        setappdata(iEEGPrepApp.UiFig, 'Setting', Setting);                                                                                       % Save the updated settings.  
